...
this_program_name="bionitio_testruby-test.sh"
...
${this_program_name}: run integration/regression tests for bionitio_testruby 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/bionitio_testruby -d data/tests
